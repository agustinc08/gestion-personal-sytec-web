...
export const employeesApi = {
  ...
  create: async (payload: Partial<Employee>) => normalizeEmployee((await api.post<Employee>('/employees', payload)).data),
  update: async (id: string, payload: Partial<Employee>) => normalizeEmployee((await api.patch<Employee>(`/employees/${id}`, payload)).data),
  updateMe: async (payload: Partial<Employee>) => normalizeEmployee((await api.patch<Employee>('/employees/me', payload)).data),
